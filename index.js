...
async function searchArtworks(size,search) {
let requestUrl12 = "https://api.artic.edu/api/v1/artworks/search?q=" + search + "&size=" + size
const response = await fetch(requestUrl12)
const data = await response.json()
